      ...
      >
        ...
        <Route
          ...
          element={
            <PlaceholderPage
              ...
              specifiedIn={['docs/PRD.md 11', 'docs/WORKFLOWS.md 2', 'docs/BUSINESS_RULES.md 6']}
            />
          }
        />
        ...
        <Route
          ...
          element={
            <PlaceholderPage
              title="Reports"
              description="Quotation, sales, approval and product analysis with export."
              plannedBehaviour={[
                'Filter by period, representative, approval status and category',
                'Best-selling and most-discounted product analysis',
                'PDF and XLS export',
              ]}
              specifiedIn={['docs/PRD.md 19']}
            />
          }
        />
